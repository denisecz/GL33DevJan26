namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrYachtAvgTicketPriceByDriveTypeMethodsWrapper

	/// <exclude/>
	public class UsrYachtAvgTicketPriceByDriveTypeMethodsWrapper : ProcessModel
	{

		public UsrYachtAvgTicketPriceByDriveTypeMethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			...
			var typeFilter = esq.CreateFilterWithParameters(FilterComparisonType.Equal, "UsrColumn10", driveTypeId); // UsrColumn10 = UsrDriveType
